...
import com.example.quick_chat_back.messaging.domain.user.aggregate.UserBuilder;
import com.example.quick_chat_back.messaging.domain.user.vo.*;
...
public class UserEntity extends AbstractAuditingEntity<Long> {
  ...
  public static Set<User> toDomain(Set<UserEntity> users) {
